...
def strategy(df_data, params):
    ...
    logs.append("Starting SMA Crossing strategy analysis...")
    ...
    logs.append("Current market state:")
    ...
    if (prev_row['SMA_fast'] <= prev_row['SMA_slow']) and (row['SMA_fast'] > row['SMA_slow']):
        ...
        logs.append("Bullish crossing detected!")
        signal = 1
        ...
        logs.append("Bearish crossing detected!")
        signal = -1
    ...
    logs.append("Strategy analysis complete")
